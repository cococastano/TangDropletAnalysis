...
save_root = '20180705_drawn_pics/'    # Root file to save pictures with drawn contours
csv_out = "20180705_cluster_data.csv" # File for CSV
...
for i in range(len(onlyfiles)):
    ...
    for c in contours:
        ...
        if A >= AREA_FLOOR and A <= AREA_CEIL:
            ...
            target = np.count_nonzero(fill) * LOWEST_QUARTER    # Sum assuming all pixels in contour at 10th percentile
